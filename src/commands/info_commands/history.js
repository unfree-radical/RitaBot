...
function getHistory (data)
{
   ...
   const guilds = function guilds (data)
   {
      ...
      if (data.cmd.params.split(" ")[1].toLowerCase() === "12k")
      {
         ...
         `# 10200 Guilds - 13/11/2021\n` +
         `# 10300 Guilds - 14/11/2021\n` +
         `# 10400 Guilds - 14/11/2021\n` +
         `# 10500 Guilds - 15/11/2021\n` +
         `# 10600 Guilds - 16/11/2021\n` +
         `# 10700 Guilds - 17/11/2021\n` +
         `# 10800 Guilds - 18/11/2021\n` +
         `# 10900 Guilds - 19/11/2021\n` +
         `# 11000 Guilds - 20/11/2021\n` +
         `# 11100 Guilds - 21/11/2021\n` +
         `# 11200 Guilds - 22/11/2021\n` +
         `# 11300 Guilds - 23/11/2021\n` +
         `# 11400 Guilds - 24/11/2021\n` +
         `# 11500 Guilds - 25/11/2021\n` +
         `# 11600 Guilds - 26/11/2021\n` +
         `# 11700 Guilds - 26/11/2021\n` +
         `# 11800 Guilds - 27/11/2021\n` +
         `# 11900 Guilds - 28/11/2021\n` +
         `# 12000 Guilds - 29/11/2021\n\n` +
         "```\n";

      }

      if (data.cmd.params.split(" ")[1].toLowerCase() === "14k")
      {
         ...
         "```md\n" +
         `# 12000 Guilds - 29/11/2021\n` +
         `# 12100 Guilds - 30/11/2021\n` +
         `# 12200 Guilds - 01/12/2021\n` +
         `# 12300 Guilds - 02/12/2021\n` +
         `# 12400 Guilds - 03/12/2021\n` +
         `# 12500 Guilds - 04/12/2021\n` +
         `# 12600 Guilds - 05/12/2021\n` +
         `# 12700 Guilds - 06/12/2021\n` +
         `# 12800 Guilds - 07/12/2021\n` +
         `# 12900 Guilds - 07/12/2021\n` +
         `# 13000 Guilds - 08/12/2021\n` +
         `# 13100 Guilds - 09/12/2021\n` +
         `# 13200 Guilds - 10/12/2021\n` +
         `# 13300 Guilds - 11/12/2021\n` +
         `# 13400 Guilds - 12/12/2021\n` +
         `# 13500 Guilds - 13/12/2021\n` +
         `# 13600 Guilds - 14/12/2021\n` +
         `# 13700 Guilds - 15/12/2021\n` +
         `# 13800 Guilds - 16/12/2021\n` +
         `# 13900 Guilds - 18/12/2021\n` +
         `# 14000 Guilds - 19/12/2021\n\n` +
         "```\n";

      }

      if (data.cmd.params.split(" ")[1].toLowerCase() === "16k")
      {
